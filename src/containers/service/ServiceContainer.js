...
export default function ServiceContainer() {
    ...
    return (
        <LayoutWrapper>
            <div className="w-full desktop:pt-140 bg-black-100 desktop:min-w-1440">
                <div className="max-w-1080 mx-auto mobile:pt-40 mobile:px-20">
                    ...
                    <div className="flex mt-186 mobile:mt-72">
                        ...
                        <div className="desktop:w-683 flex flex-wrap mobile:justify-between mobile:px-10">
                            <div className="desktop:hidden text-32 font-bold flex items-center text-white w-140 h-140 justify-center">
                                개발
                            </div>
                            {
                    ...
                    <div className="flex mt-140">
                        ...
                        <div className="flex mobile:flex-wrap mobile:px-10 mobile:justify-between">
                            <div className="desktop:hidden text-32 font-bold flex items-center text-white w-140 h-140 justify-center">
                                디자인
                            </div>
                            {
